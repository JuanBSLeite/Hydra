...
#ifndef BreitWigner_H_
#define BreitWigner_H_
...
class BreitWigner: public hydra::BaseFunctor<BreitWigner<CHANNEL,L>, hydra::complex<double>, 4>
{
	using hydra::BaseFunctor<BreitWigner<CHANNEL,L>, hydra::complex<double>, 4>::_par;
...
public:
	...
	BreitWigner(hydra::Parameter const& c_re, hydra::Parameter const& c_im,
			...
			double radi):
			hydra::BaseFunctor<BreitWigner<CHANNEL,L>, hydra::complex<double>, 4>{c_re, c_im, mass, width},
			fLineShape(mass, width, mother_mass, daugther1_mass, daugther2_mass, daugther3_mass, radi)
	{}


    __hydra_dual__
	BreitWigner( BreitWigner< CHANNEL,L> const& other):
	hydra::BaseFunctor<BreitWigner<CHANNEL ,L>, hydra::complex<double>, 4>(other),
	fLineShape(other.GetLineShape())
	{}

    __hydra_dual__  inline
	BreitWigner< CHANNEL ,L>&
	operator=( BreitWigner< CHANNEL ,L> const& other)
	{
		if(this==&other) return *this;

		hydra::BaseFunctor<BreitWigner<CHANNEL ,L>, hydra::complex<double>, 4>::operator=(other);
		fLineShape=other.GetLineShape();
